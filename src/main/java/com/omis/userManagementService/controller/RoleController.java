...
public class RoleController {
    ...
    @Autowired
    public RoleController(RoleService roleService,  RouteRepository routeRepository, CategoryRepository categoryRepository) {
    ...
    public ResponseEntity<List<Map<String, Object>>> getAllRouteNames() {
        ...
        for (Route route : routes) {
            ...
            routeInfo.put("add", route.getAdd());
            routeInfo.put("edit", route.getEdit());
            routeInfo.put("delete", route.getDelete());
